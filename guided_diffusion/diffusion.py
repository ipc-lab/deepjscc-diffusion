...
class NewImageFolder(data.Dataset):
    def __init__(self, data_path, transform=None):
        print(os.path.join(data_path, "*.png"))
...
class CombinedDataset(data.Dataset):
    def __init__(self, args, config):
        data_path = os.path.join(args.target, [f for f in os.listdir(args.target) if "snr" in f][0]) #"/home/sfy21/deepjscc-local/logs/diffjscc_eval2_new/multiruns/2023-09-06_02-25-11/1/test_images_degraded_snr-3_-3/"
        self.deepjscc = NewImageFolder(data_path,
            transform=transforms.Compose([transforms.ToTensor()])
        )
        
        data_path = os.path.join(args.target, "test_images_original") #"/home/sfy21/deepjscc-local/logs/diffjscc_eval2_new/multiruns/2023-09-06_02-25-11/1/test_images_original/"
        self.dataset = NewImageFolder(
            data_path,
            transform=transforms.Compose([transforms.ToTensor()])
        )
    ...
    def __getitem__(self, idx):
        return idx, self.dataset[idx], self.deepjscc[idx]
    ...
    def sample(self, simplified):
        ...
        if self.config.model.type == 'simple':
            ...
            if name != 'celeba_hq':
                ...
                ckpt = "./models/512x512_diffusion_uncond_finetune_008100.pt"
            ...
            with torch.no_grad():
                ...
                for i, j in tqdm.tqdm(time_pairs):
                    ...
                    if j < i: # normal sampling 
                        ...
                        # Eq. 17
                        #print(x0_t.shape, y.shape, A(x0_t).shape)
